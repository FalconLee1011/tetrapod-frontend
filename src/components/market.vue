  ...
  <v-card
    ...
    >
      <v-card-text>
        ...
        <v-col cols="2">
            <span style="font-size:150%;padding:12px;">{{marketname}}</span><br>
            <v-rating
              class="pa-3"
              dense
              :value=market_star
        ...
        <v-col cols="1">
          <spacer></spacer><br>
        <v-btn icon x-large><v-icon size="40"> mdi-message-text-outline </v-icon></v-btn>
        </v-col>
        <v-col cols="8">
